...
func TestAnonymous(t *testing.T) {
	...
	assert.Equal(t, do.Exception.ExceptionDetails[0].ExceptionCallFile, po.Exception.ExceptionDetails[0].ExceptionCallFile)
	assert.Equal(t, do.Exception.ExceptionDetails[0].ExceptionCallLine, po.Exception.ExceptionDetails[0].ExceptionCallLine)
	assert.Equal(t, do.Exception.ExceptionDetails[0].ExceptionCallFuncName, po.Exception.ExceptionDetails[0].ExceptionCallFuncName)
